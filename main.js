...
(function() {
  var FPS, Node, Point, addNewPoint, canvas, colors, ctx, docClicked, drag, fill_colors, fps_el, fps_timer, getNodeForPoint, hot_points, i, keyDowned, log, mouse, mouseMoved, past_now, points, pre_canvas, pre_ctx, quad_tree, renderFrame, update_fps, _i;
  ...
  docClicked = function(evt) {
    var node;
    return node = getNodeForPoint(evt.clientX, evt.clientY);
  };
  ...
  return document.addEventListener('mousemove', mouseMoved);
})();
